...
Write a function called `findUserByUsername` which accepts an array of objects, each with a key of username, and a string.
 The function should return the first object with the key of username that matches the string passed to the function. If the object is 
...
function removeUser(usersArray, username) {
  let k = usersArray.findIndex(function(o) {
    return o.username == username;
  });
  if (k == -1) {
    return undefined;
  }
  return usersArray.splice(k,1)[0];
}